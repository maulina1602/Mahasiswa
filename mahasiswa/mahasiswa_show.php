    ...
    <div class="card-body">
        ...
        <nav class="mb-5">
            ...
            if ($page == 1) {
                ...
                '<li class="page-item"><a class="page-link" href="?page=mahasiswa-show&halaman=1">First</a></li>';
                '<li class="page-item"><a class="page-link" href="?page=mahasiswa-show&halaman=' . $link_prev . '" arial-label="Previous"><span aria-hidden="true">&laguo;</span></a></li>';
            }
